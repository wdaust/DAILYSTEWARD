...
export default function Settings() {
  ...
  return (
    <SafeAreaView
      className={`flex-1 ${isDarkMode ? "bg-gray-900" : "bg-secondary-200"}`}
    >
      <Stack.Screen
        options={{
      ...
      >
        ...
        >
          ...
          <Text
            className={`text-xl font-bold ${isDarkMode ? "text-white" : "text-neutral-800"}`}
          >
            JW Companion Settings
          </Text>
          <Text
            className={`text-sm ${isDarkMode ? "text-gray-400" : "text-neutral-500"} text-center mt-1`}
          >
        ...
        <View className="space-y-6">
          ...
          {/* Dashboard Settings */}
          <View
            className={`${isDarkMode ? "bg-gray-800" : "bg-white"} p-6 rounded-2xl shadow-card mb-4`}
          >
            <Text
              className={`text-xl font-semibold mb-4 ${isDarkMode ? "text-white" : "text-neutral-800"}`}
            >
              Dashboard Settings
            </Text>
            ...
            >
              <TouchableOpacity className="flex-row justify-between items-center">
                <Text
                  className={`${isDarkMode ? "text-gray-300" : "text-neutral-700"}`}
                >
          ...
          {/* App Information */}
          <View
            className={`${isDarkMode ? "bg-gray-800" : "bg-white"} p-6 rounded-2xl shadow-card`}
          >
            <Text
              className={`text-xl font-semibold mb-4 ${isDarkMode ? "text-white" : "text-neutral-800"}`}
            >
          ...
          <Text
            className={`text-center text-xs ${isDarkMode ? "text-gray-400" : "text-neutral-500"} mb-6`}
          >
